 ...
 topics: [
  ...
  extraContent: {
    currentCertification: {
      it:["Aggiornato il 23 agosto 2026 sul blueprint Cisco 200-301 v1.1.","1361 practice question in 10 topic, 10 Reviews e mock exam distribuito 20/20/25/10/15/10.","18 lab interattivi: 4 gratuiti e 14 inclusi negli accessi che comprendono i lab.","Le practice question allenano concetti e rapidità; il mock exam miscela i domini; le Reviews spiegano; i lab richiedono decisioni operative."],
      en:["Updated August 23, 2026 against the Cisco 200-301 v1.1 blueprint.","1361 practice questions across 10 topics, 10 Reviews, and a 20/20/25/10/15/10 blueprint-balanced mock exam.","18 interactive labs: 4 free and 14 included with access levels that contain labs.","Practice questions build knowledge and speed; the mock exam mixes domains; Reviews explain concepts; labs require operational decisions."],
      fr:["Mis à jour le 23 août 2026 selon le blueprint Cisco 200-301 v1.1.","1361 questions dans 10 thèmes, 10 Reviews et un mock exam réparti 20/20/25/10/15/10.","18 labs interactifs : 4 gratuits et 14 inclus dans les accès comprenant les labs.","Les questions développent connaissances et rapidité ; le mock exam mélange les domaines ; les Reviews expliquent ; les labs demandent des décisions opérationnelles."],
      es:["Actualizado el 23 de agosto de 2026 según el blueprint Cisco 200-301 v1.1.","1361 preguntas en 10 temas, 10 Reviews y un mock exam distribuido 20/20/25/10/15/10.","18 labs interactivos: 4 gratuitos y 14 incluidos en los accesos que contienen labs.","Las preguntas desarrollan conocimiento y velocidad; el mock exam mezcla dominios; las Reviews explican; los labs requieren decisiones operativas."],
    },
    learn: {
      it: [
