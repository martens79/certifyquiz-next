...
const COPY: Record<Lang, CopyEntry> = {
  it: {
    ...
    testimonials: [
      { text: "Ho passato il CCNA al primo tentativo dopo 3 settimane di quiz su CertifyQuiz. Le spiegazioni Premium fanno davvero la differenza.", name: "Marco R.", cert: "Cisco CCNA" },
  ...
  es: {
    ...
    testimonials: [
      { text: "Aprobé el CCNA al primer intento después de 3 semanas con CertifyQuiz. Las explicaciones Premium marcan la diferencia.", name: "Carlos M.", cert: "Cisco CCNA" },
  ...
  en: {
    ...
    testimonials: [
      { text: "Passed the CCNA on my first attempt after 3 weeks of quizzes on CertifyQuiz. The Premium explanations make a real difference.", name: "Mark R.", cert: "Cisco CCNA" },
  ...
  fr: {
    ...
    testimonials: [
      { text: "J'ai réussi le CCNA du premier coup après 3 semaines de quiz sur CertifyQuiz. Les explications Premium font vraiment la différence.", name: "Marc R.", cert: "Cisco CCNA" },
...
function Guarantee({ t }: { t: CopyEntry }) {
  return (
    <div className="mt-6 flex items-start gap-4 rounded-2xl border border-emerald-200 bg-emerald-50 p-5">
      ...
      <div>
        <div className="text-base font-semibold text-emerald-900">{t.guaranteeTitle}</div>
