...
const roadmapItems = [
  ...
  {
    title: "Database",
    desc: "Fondamenti SQL, database relazionali, amministrazione e alternative NoSQL.",
    href: "/it/roadmap-databases",
    icon: "🗄️",
    badge: "DATA",
  ...
  },
  {
    ...
    desc: "Dalla logica di base ai linguaggi, alla programmazione a oggetti e ai progetti pratici.",
    href: "/it/roadmap-programming",
    icon: "💻",
    badge: "DEV",
    certs: ["Programming Foundations", "Python", "C#", "JavaScript"],
    color: "from-indigo-50 via-white to-white",
  },
  {
    title: "Virtualizzazione",
    desc: "Fondamenti di VM, amministrazione, troubleshooting e piattaforme enterprise.",
    href: "/it/roadmap-virtualization",
    icon: "🖥️",
    badge: "INFRA",
    certs: ["Virtualization Foundations", "VMware VCP"],
