...
// Base assoluta (puoi usare l'env in produzione)
...
export async function generateMetadata(
  ...
  return {
    ...
    openGraph: {
      ...
      title: `${getLabel(T.title, lang)} | CertifyQuiz`,
      description: {
        it: "Regole di utilizzo del servizio CertifyQuiz.",
        en: "Rules for using the CertifyQuiz service.",
        fr: "Règles d’utilisation du service CertifyQuiz.",
        es: "Reglas de uso del servicio CertifyQuiz.",
      }[lang],
