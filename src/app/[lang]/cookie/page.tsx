...
// Meglio assoluto per canonical/og
...
export async function generateMetadata(
  ...
  return {
    ...
    openGraph: {
      ...
      title: `${getLabel(T.title, lang)} | CertifyQuiz`,
      description: {
        it: "Informazioni sull'uso dei cookie su CertifyQuiz.",
        en: "Information about cookie usage on CertifyQuiz.",
        fr: "Informations sur l’utilisation des cookies sur CertifyQuiz.",
        es: "Información sobre el uso de cookies en CertifyQuiz.",
      }[lang],
